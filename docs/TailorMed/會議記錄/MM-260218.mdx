...
- [ ]相關報價單提供，會包含以下：
  - 1.Sales Rep. 專用 Interface 報價單
  - 2.CRM Interface(可正式操作功能：包含列表，可編輯詳細資料，新增項目)報價單
  - 3.FIN Interface with One Click Match 功能(可正式操作功能如 CRM Interface)報價單
  - 4.Airtable Editor Seat (ray@tailormed-intl.com)與系統授權報價單
  - 5.US Database 建置及 Interface 操作介面報價單
